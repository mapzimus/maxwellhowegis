...
window.V2_DATA.projects = [
  ...
  },
  {
    ...
    "summary": "An interactive 3D globe built from 1,035 real North Shore Nostalgia shipments, with city-level geocoding, great-circle journeys, international handoffs, privacy-safe financial rankings, sales records, and a cumulative timeline.",
    ...
    "outcome": "The live map now shows 1,035 packages across 800 destination cities, including recovered international legs and military mail generalized to Okinawa, while automated tests prevent names, addresses, order identifiers, tracking numbers, dollar amounts, and other customer data from entering the published dataset.",
    "tools": [
      "Python",
      "MapLibre GL JS",
      "Nominatim",
