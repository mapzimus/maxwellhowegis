...
const projects = [
    ...
    },
    {
        ...
        category: "Web Mapping",
        type: "map",
        tags: ["MapLibre", "3D Globe", "Geocoding", "Privacy", "eBay API"],
        summary: "An interactive 3D globe built from 1,035 real North Shore Nostalgia shipments, with city-level geocoding, great-circle journeys, visible eBay international handoffs, privacy-safe financial rankings, and a cumulative month-by-month animation.",
        description: "A portfolio piece built from my own eBay business, North Shore Nostalgia. The project takes real sales history for used games, strips it down to a privacy-safe public dataset, geocodes destinations only to city and town centers, and maps how far packages have travelled from Salem, Massachusetts. The MapLibre 3D globe uses densified great-circle arcs that follow the sphere, including safe handling across the antimeridian. eBay International Shipping orders are shown as two-stage journeys when the source export includes both the Illinois handoff hub and the true destination; older hub-only records are labeled honestly instead of guessing where they continued. The dashboard also includes filters, a cumulative month-by-month timeline, destination and distance records, busiest periods, repeat-city and long-haul statistics, a longest-journey callout, and a scheduled GitHub Actions workflow that can pull new eBay orders when API credentials are configured. The raw order data stays private; the public dataset contains only generalized destinations, sale month, game titles, quantities, approximate city-to-city distance, and an optional city-level handoff.",
        tools: ["MapLibre GL JS", "Python", "Nominatim", "eBay Fulfillment API", "GitHub Actions", "GitHub Pages"],
        year: "2026",
