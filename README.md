...
| Path | What | Tech |
|---|---|---|
| [`/`](https://maxwellhowegis.com) | Professional Web GIS portfolio with featured case studies, graduate work, About, and Contact | Vanilla JS, generated from `src/portfolio/` |
| [`/lidar-test/`](https://maxwellhowegis.com/lidar-test/) | **Lidar Site Studies** — planning-level terrain intelligence for wooded Massachusetts land. Four public-data case studies (Devens, Middleborough, Hopkinton, and an I-495 corridor screen) covering bare-earth vs. canopy surfaces, canopy height, terrain wetness, viewsheds, access grades, and cut/fill earthwork. Featured on the portfolio. | MassGIS lidar, GDAL, WhiteboxTools, Python, Leaflet, vanilla JS |
...
| [WhydahStory.com](https://whydahstory.com/) (external) | Custom 3D globe flythrough + curriculum dashboard for a middle-school PBL unit on the 1717 Whydah Gally shipwreck. Lives in its own repo ([`mapzimus/Whydah-Unit`](https://github.com/mapzimus/Whydah-Unit)); the old `/whydah/` vendored copy here is retired — `404.html` forwards `/whydah/*` deep links to whydahstory.com. | MapLibre GL JS, Esri World Imagery, vanilla JS |
...
| [`/work/ebay-packages/`](https://maxwellhowegis.com/work/ebay-packages/) | North Shore Nostalgia Sales Atlas — spatial business analysis of real eBay order destinations | MapLibre, Python |
