...
- [x] **Auto-generated full network** (`scripts/build_network.py`): 130 HSR + 2,196 regional
      (incl. 990 tier-2b + 493 corridor gap-fill hubs) + 7,610 metro nodes in 1,129 gap-driven
      organic systems; every town ≤ 60 mi from a hub; 29,105 tier-4 town nodes plotted
